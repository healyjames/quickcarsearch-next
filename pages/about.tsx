        ...
        <React.Fragment>
            ...
            <main>
                <Layout>
                    ...
                    <p>I started this project for fun. I enjoy cars and I enjoy writing code so I put the two together, simple as that. It gives myself the opportunity to hone my dev skills and it allows me to really explore how to make a seriously fast, user friendly, good-looking and (maybe most importantly) useful website. Every decision I make here, I try and ask myself "does the user find any value in this?". Working on quickcarsearch.io gets me to think about how I can best implement and really perfect important web development concepts like SEO, Core Web Vitals and site performance as well as giving me the chance to use some of the latest and greatest technologies on offer.</p>
                    <p>Quickly, while we're on the subject, for any techies out there reading this and wondering, I built this site using the latest version of NextJS (which runs with Vercel  under the hood). Its hosted with GoDaddy and deployed with AWS amplify. There really is not much more to it - which is key principle I have when it comes to building this project out: simplicity is king. Don't overwhelm the user. Don't pump rubbish into the codebase. Don't make life difficult for yourself! </p>
